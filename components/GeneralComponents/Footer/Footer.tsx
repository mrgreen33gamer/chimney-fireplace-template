...
const SERVICE_LINKS = [
  { href: '/services/chimney-sweep',     label: 'Chimney Sweep' },
  { href: '/services/chimney-repair',         label: 'Chimney Repair' },
  { href: '/services/fireplace-install',        label: 'Fireplace Installation' },
  { href: '/services/cap-damper',  label: 'Caps & Dampers' },
  { href: '/services/annual-inspection',label: 'Annual Inspections' },
  { href: '/services/dryer-vent', label: 'Dryer Vent Cleaning' },
];
...
const TRUST_ITEMS = [
  ...
  { icon: faWrench,       label: 'CSIA-Certified' },
  { icon: faClock,        label: 'Same-Day Service' },
  { icon: faBolt,         label: 'Clean Sweep Guarantee' },
];

const SOCIALS = [
  { href: 'https://facebook.com/emberstackchimney', icon: faFacebookF, label: 'Facebook' },
  { href: 'https://g.page/r/emberstackchimney',     icon: faGoogle,    label: 'Google' },
];
          ...
          <div className={styles.brandCol}>
            <Link href="/" className={styles.logo}>
              ...
              <div className={styles.logoText}>
                <span className={styles.logoName}>EmberStack Chimney & Fireplace</span>
                <span className={styles.logoSub}>Waco, Texas</span>
              </div>
            </Link>

            <p className={styles.tagline}>
              Flat-rate pricing. Same-day service. Zero contracts — ever. Serving Central Texas homes and businesses since 2006.
            </p>

            <div className={styles.contactBlock}>
              <a href="tel:+12548404040" className={styles.phoneLink}
                onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Footer Phone', section: 'Footer-Brand' })}>
                <FontAwesomeIcon icon={faPhone} />
                (254) 840-4040
              </a>
              <a href="mailto:hello@emberstackchimney.com" className={styles.emailLink}
                onClick={() => trackEvent({ eventType: 'email_click', elementLabel: 'Footer Email', section: 'Footer-Brand' })}>
                <FontAwesomeIcon icon={faEnvelope} />
                hello@emberstackchimney.com
              </a>
              <span className={styles.addressLine}>
                <FontAwesomeIcon icon={faLocationDot} />
                1500 N 15th St, Waco, TX 76707
              </span>
            </div>
      ...
      <div className={styles.bottomBar}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            &copy; {new Date().getFullYear()} EmberStack Chimney & Fireplace. All Rights Reserved. | CSIA-Certified · Bonded & Insured
          </p>
          <a href="tel:+12548404040" className={styles.emergencyBtn}
