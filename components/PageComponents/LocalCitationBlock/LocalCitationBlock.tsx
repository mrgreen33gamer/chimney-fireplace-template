...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'EmberStack Chimney & Fireplace',
  address       = 'Waco, TX 76707',
  phone         = '(254) 840-4040',
  email         = 'service@emberstackchimney.com',
  googleMapsUrl = 'https://maps.google.com/?q=EmberStack+Door+Pros+chimney+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with licensed chimney technicians.
          </p>
        </div>
