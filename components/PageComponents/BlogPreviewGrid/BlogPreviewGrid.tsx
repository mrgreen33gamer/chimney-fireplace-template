...
const BlogPreviewGrid: React.FC<BlogPreviewGridProps> = ({
  title       = 'Chimney & Fireplace Tips & Insights',
  subtitle    = 'Practical advice for Central Texas homeowners — sweep schedules, creosote safety, and fireplace upgrade costs.',
  posts,
  count       = 4,
  viewAllLink = '/blogs',
