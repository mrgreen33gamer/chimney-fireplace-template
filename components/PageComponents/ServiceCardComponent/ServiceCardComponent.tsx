...
export default function ServiceCardComponent({
  cards,
  heading    = 'Everything Your Chimney Needs',
  subheading = 'From chimney sweeps to fireplace installs, EmberStack Chimney & Fireplace handles it all — on time, on price.',
