...
const INDUSTRIES = [
  ...
  { slug: 'historic-homes',          label: 'Historic Homes', icon: faHardHat },
  { slug: 'hospitality', label: 'Hospitality & Lodging',     icon: faIndustry },
];
...
export default function SectionIndustriesServed({
  ...
  subtitle = 'Chimney and fireplace programs — built for how your industry actually works.',
  disableLinks = false,
