...
const SERVICES = [
  { icon: faWrench,        label: 'Chimney Sweep',  sub: 'Creosote removal & flue cleaning' },
  { icon: faLink,          label: 'Chimney Repair',      sub: 'Crown, flashing, masonry repair' },
  { icon: faDoorOpen,      label: 'Fireplace Install',    sub: 'Wood, gas & insert installs' },
  { icon: faCogs,          label: 'Caps & Dampers',      sub: 'Caps, spark arrestors, dampers' },
  { icon: faClipboardList, label: 'Annual Inspection',    sub: 'Level 1–2 safety inspection' },
  { icon: faBuilding,      label: 'Dryer Vent Cleaning',    sub: 'Full-run lint removal' },
  { icon: faBolt,          label: 'Emergency',           sub: 'Smoke, leak, or animal emergency' },
];
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    A licensed EmberStack Chimney & Fireplace tech will reach out about your <strong>{selectedService}</strong> service.
                  </p>
