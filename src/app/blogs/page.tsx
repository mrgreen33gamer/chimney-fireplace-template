    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>EmberStack Chimney & Fireplace — Blog Center</h1>
          <p className={styles.pageSubtitle}>
            Practical chimney safety tips, creosote guidance, and fireplace maintenance advice for Central Texas homeowners.
          </p>
        </motion.div>
      </section>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need a licensed chimney technician in Central Texas?
            </p>
            <p className={styles.blogCTABody}>
              We&apos;ve been protecting Waco-area homes and businesses with expert chimney sweeps, repairs, and fireplace installations since 2006. Free estimate, no obligations.
            </p>
