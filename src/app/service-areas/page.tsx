...
// EmberStack Chimney & Fireplace — Service Areas Page
'use client';
...
const SERVICE_AREAS = [
  {
    ...
    badge:       'Home Base',
    description: 'Our headquarters. Fastest response times, same-day service available 7 days a week. Full chimney sweep, repair, fireplace install, caps & dampers, dryer vents, and annual inspections across all of Waco.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: 'Full chimney coverage for Hewitt homes and businesses. Fast dispatch from our Waco base — typically under 45 minutes.',
    highlights:  ['45-min dispatch', 'Residential & commercial', 'Fireplace & insert upgrades'],
  },
  {
    city:        'Woodway',
    slug:        'woodway-tx',
    county:      'McLennan County',
    badge:       'Primary Area',
    description: "Serving Woodway's residential neighborhoods with the same flat-rate pricing and Clean Sweep Guarantee · Fully Insured as every other area we cover.",
    highlights:  ['Flat-rate pricing', 'Clean Sweep Guarantee · Fully Insured', 'CSIA-certified'],
  },
  {
    city:        'Bellmead',
    slug:        'bellmead-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Reliable chimney service for Bellmead residents and businesses. Fireplace & insert upgrades, repairs, and lighting installs — same-day when available.',
    highlights:  ['Residential & commercial', 'CSIA-certified chimney technicians', 'No contracts'],
  },
  {
    city:        'China Spring',
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Rural and residential chimney service for the China Spring area. We make the drive — flat-rate pricing applies just the same.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Chimney sweep, repair, and fireplace service for McGregor homes and light commercial properties.',
    highlights:  ['Residential & light commercial', 'Fireplace & insert upgrades', 'Same-day when available'],
  },
  {
    city:        'Killeen',
    slug:        'killeen-tx',
    county:      'Bell County',
    badge:       '',
    description: 'Chimney repair, installation, and upgrades for Killeen and Fort Cavazos area homes and businesses. Military-friendly scheduling.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Full-service chimney coverage for Temple. Medical district and surrounding neighborhoods served. Full residential and commercial fireplaces and chimneys.',
...
const faq = [
  ...
  {
    question: 'Do you work on commercial fireplaces and chimneys in all areas?',
    answer: 'Yes — light commercial fireplaces and chimneys for restaurants, offices, retail spaces, and small warehouses is within scope across all our coverage areas. Call to discuss your specific project and location.',
  },
  {
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          ...
          >
            <div className={styles.heroBadge}>
              ...
              Central Texas Chimney — Since 2006
            </div>
            ...
            <p className={styles.heroSub}>
              Based in Waco, serving all of Central Texas. Flat-rate pricing, CSIA-certified chimney technicians, and a Clean Sweep Guarantee · Fully Insured — no matter where you are.
            </p>
            <div className={styles.heroActions}>
              <a href="tel:+12548404040" className={styles.heroCTAPrimary}>
        ...
        <div className={styles.areasSectionInner}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSub}>
              Click any city to see local service details, common chimney issues in your area, and what to expect from our team.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.areaFooter}>
                    <a href="tel:+12548404040" className={styles.areaCallBtn}>
      ...
      <section className={styles.unlisted}>
        <div className={styles.unlistedInner}>
          ...
          <a href="tel:+12548404040" className={styles.unlistedCTA}>
            Call (254) 840-4040
          </a>
        </div>
      </section>
      ...
      <CTABanner
        ...
        subline="Same-day service available across Central Texas. Flat-rate pricing, Clean Sweep Guarantee · Fully Insured, no contracts ever."
