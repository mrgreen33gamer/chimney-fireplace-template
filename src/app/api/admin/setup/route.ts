...
const SITE_URL    = process.env.NEXT_PUBLIC_SITE_URL ?? 'https://www.emberstackchimney.com';
const BRAND_NAME  = process.env.NEXT_PUBLIC_BRAND_NAME ?? 'EmberStack Chimney & Fireplace';
    ...
    <tr>
      <td align="center" style="padding:40px 16px;">
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0"
          ...
          <!-- Accent bar -->
          <tr>
            <td style="height:4px;background:linear-gradient(90deg,#16def9 0%,#9a3412 100%);font-size:0;line-height:0;">&nbsp;</td>
          </tr>
          ...
          <tr>
            <td style="padding:24px 40px 8px 40px;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="border-radius:10px;background:#9a3412;">
                    <a href="${dashboardUrl}"
