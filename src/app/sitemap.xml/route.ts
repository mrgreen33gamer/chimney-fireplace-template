...
// EmberStack Chimney & Fireplace — XML Sitemap
...
export async function GET() {
  const baseUrl = 'https://www.emberstackchimney.com';
  ...
  // ── Core service pages ─────────────────────────────────────────────────────
  const coreServices = [
    { url: '/services/chimney-sweep',     priority: '0.95', changefreq: 'weekly'  },
    { url: '/services/chimney-repair',    priority: '0.90', changefreq: 'weekly'  },
    { url: '/services/fireplace-install',  priority: '0.90', changefreq: 'weekly'  },
    { url: '/services/cap-damper',    priority: '0.85', changefreq: 'monthly' },
    { url: '/services/annual-inspection',       priority: '0.85', changefreq: 'monthly' },
    { url: '/services/dryer-vent',       priority: '0.85', changefreq: 'monthly' },
  ];
