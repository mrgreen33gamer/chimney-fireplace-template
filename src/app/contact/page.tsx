...
// EmberStack Chimney & Fireplace — Contact Page (unique build, not just a form import)
...
// ── Service options ────────────────────────────────────────────────────────────
const SERVICES = [
  'Chimney Sweep', 'Chimney Repair', 'Fireplace Installation',
  'Caps & Dampers', 'Annual Inspections', 'Dryer Vent Cleaning',
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 840-4040. We answer 7 days a week including evenings. For a genuine chimney emergency in Central Texas, call — don't wait on a form response.",
  },
  {
  ...
  {
    question: 'Do you work on commercial chimney systems?',
    answer: 'Yes — light commercial chimney for restaurants, offices, retail spaces, and small warehouses is within our scope. Call to discuss your specific system and location.',
  },
  {
  ...
  },
  {
    ...
    answer: "Our tech will tell you honestly after the diagnosis. If repair costs approach a full rebuild, we'll show both paths with flat-rate numbers and let you decide.",
  },
];
  ...
  return (
    <main className={styles.page}>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@emberstackchimney.com',
                  href:      'mailto:hello@emberstackchimney.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '1500 N 15th St, Waco TX 76701',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose EmberStack Chimney & Fireplace</p>
              {[
                'Flat-rate pricing — written quote before we start',
                '1-year parts & labor warranty on every repair',
                'CSIA-certified sweeps only',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A licensed EmberStack Chimney & Fireplace chimney technician will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12548404040">(254) 840-4040</a>.
                  </p>
      ...
      <CTABanner
        ...
        subline="Call (254) 840-4040 — we answer 7 days a week, evenings included. Emergency service available across Central Texas."
        primaryText="Call (254) 840-4040"
        primaryLink="tel:+12548404040"
        secondaryText="Send a Text"
        secondaryLink="sms:+12548404040"
      />
